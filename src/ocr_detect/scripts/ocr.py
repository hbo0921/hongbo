...
def Draw_OCRResult(blank_img, pt1, pt2, text):
    ...
    fontStyle = ImageFont.truetype("/home/abot/310117/src/ocr_detect/ChineseFonts/simsun.ttc", size=21, encoding="utf-8")
    (x, y) = pt1
...
def ocr_detect():
    ...
    img_path = rospy.get_param('image_path', "/home/abot/310117/src/abot_vlm/temp2/vl_now.jpg")
    ...
    while not rospy.is_shutdown():
        ...
        save_path = f'/home/abot/310117/src/ocr_detect/result/OCR_result_{file_name}.jpg'
