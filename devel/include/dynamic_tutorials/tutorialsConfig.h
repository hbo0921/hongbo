...
// *********************************************************
//
// File autogenerated for the my_msgs package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __my_msgs__TUTORIALSCONFIG_H__
#define __my_msgs__TUTORIALSCONFIG_H__
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(tutorialsConfig::AbstractParamDescriptionConstPtr(new tutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 13, 'description': 'A small constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 14, 'description': 'A medium constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 15, 'description': 'A large constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 16, 'description': 'A extra large constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Extralarge'}]}", &tutorialsConfig::size)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(tutorialsConfig::AbstractParamDescriptionConstPtr(new tutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 13, 'description': 'A small constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 14, 'description': 'A medium constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 15, 'description': 'A large constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 16, 'description': 'A extra large constant', 'srcfile': '/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Extralarge'}]}", &tutorialsConfig::size)));
...
//#line 13 "/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg"
      const int tutorials_Small = 0;
//#line 14 "/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg"
      const int tutorials_Medium = 1;
//#line 15 "/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg"
      const int tutorials_Large = 2;
//#line 16 "/home/abot/310117/src/dynamic_tutorials/dynamic_tutorials/cfg/Tutorials.cfg"
